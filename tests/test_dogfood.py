...
def test_dogfood_atlas_session_lifecycle(tmp_path):
    ...
    # 1. Create a session
    res = bridge.create_session(project="test-proj", task="Implement tests", description="Writing tests")
    ...
    res2 = bridge.create_session(project="second-proj", task="Documentation", description="Write docs")
